...
double AccelStepper::distanceToGo()
{
    return _targetPos - _currentPos;
}

double AccelStepper::targetPosition()
{
    return _targetPos;
}

double AccelStepper::currentPosition()
{
    return _currentPos * pos_multiplier;
}
...
{
    double distanceTo = distanceToGo(); // +ve is clockwise from curent location
